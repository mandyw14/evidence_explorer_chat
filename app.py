...
st.caption(
    "This search prioritizes human clinical studies, clinical trials, reviews, and evidence syntheses published in English within the past 10 years."
)
...
condition = st.text_input(
    ...
    help="Type any neurological condition, e.g., Parkinson disease, dementia, epilepsy, migraine.",
)
...
auto_query = build_pubmed_query(condition, interventions, years_back=years_back)
...
if search:
    if not condition.strip():
        st.warning("Please enter a neurological condition.")
        st.stop()
