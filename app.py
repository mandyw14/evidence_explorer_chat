...
selected_category = st.selectbox(
    ...
    index=0,
    help=(
        "Treatments and interventions are organized into categories "
        "to help you explore different approaches to neurological health. "
        "After selecting a category, you can choose one or more specific "
        "interventions to include in your search."
    ),
)
